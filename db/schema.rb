...
ActiveRecord::Schema.define(version: 20150505124600) do
  ...
  add_index "games", ["cached_votes_score"], name: "index_games_on_cached_votes_score", using: :btree
  add_index "games", ["cached_votes_total"], name: "index_games_on_cached_votes_total", using: :btree
  add_index "games", ["cached_votes_up"], name: "index_games_on_cached_votes_up", using: :btree
